    ...
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-lg font-semibold">Ai WebsiteBuilder</div>
                  ...
                  {openProfile && (
                    <>
                      <motion.div
                        ...
                        className="absolute right-0 mt-3 e-60 z-50 rounded-xl bg-[#0b0b0b] border border-white/10 shadow-2xl overflow-hidden"
                      >
      ...
      <section className="pt-44 pb-32 px-6 text-center">
        ...
        <button
          className="mt-10 px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105 transition"
          onClick={() => {
            ...
            {highlights.map((h, i) => (
              ...
              >
                ...
                <p className="text-sm text-zinc-400">
                  AI WebsiteBuilder builds real websites - clean code,
      ...
      <footer className="border-t border-white/10 py-10 text-center text-sm text-zinc-500">
        &copy; {new Date().getFullYear()} AI WebsiteBuilder
      </footer>
