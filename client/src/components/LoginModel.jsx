          ...
          >
            <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
              ...
              <div className="relative px-8 pt-14 pb-10 text-center">
                <h1 className="inline-block mb-6 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-sx text-zinc-300">
                  AI-powered website builder
                </h1>
                <h2 className="text-3xl font-semibold leading-tight mb-3 space-x-2">
                  <span className="text-xl">Welcome to</span>
                  <span className="bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent text-2xl">
                    Ai WebsiteBuilder
                  </span>
                </h2>
                ...
                <p className="text-xs hover:text-zinc-300 leading-relaxed">
