...
export const generateWebiste = async (req, res) => {
  try {
    ...
    console.log(error);
    return res.status(201).json({ message: `generate website error ${error}` });
  }
};
...
export const getWebsiteById = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "website get Error" });
  }
};
  ...
  try {
    ...
    if (user.credits < 25) {
      return res.status(400).json({
        message: "You have not enough credits to generate Website",
      });
    }
    ...
    return res.status(500).json({ message: "update website Error" });
  }
};
...
export const getAll = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: " get All Error" });
  }
};
...
export const getBySlug = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: "website get by slug error" });
  }
};
